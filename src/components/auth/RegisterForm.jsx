...
export default function RegisterForm({
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="relative group">
            <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-3">
              <FaUser className="text-[#4945E7] dark:text-[#6A67F0] text-lg transition-all duration-300 group-focus-within:scale-110" />
            </div>
            <input
              type="text"
              name="firstName"
              ...
              className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-xl pr-10 pl-3 py-3.5 outline-none focus:ring-2 focus:ring-[#4945E7] dark:focus:ring-[#6A67F0] focus:border-transparent transition-all duration-200 group-hover:border-[#4945E7]/50 dark:group-hover:border-[#6A67F0]/50 text-sm text-right"
            />
          </div>
        ...
        <div className="relative group">
          ...
          <input
            ...
            className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-xl pr-12 pl-4 py-3.5 outline-none focus:ring-2 focus:ring-[#4945E7] dark:focus:ring-[#6A67F0] focus:border-transparent transition-all duration-200 group-hover:border-[#4945E7]/50 dark:group-hover:border-[#6A67F0]/50 text-right"
          />
        </div>

        <div className="relative group">
          <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-4">
            <FaPhone className="text-[#4945E7] dark:text-[#6A67F0] text-lg transition-all duration-300 group-focus-within:scale-110" />
          </div>
          <input
            type="tel"
            name="phoneNumber"
        ...
        <div className="relative group">
          ...
          <input
            ...
            className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-xl pr-12 pl-12 py-3.5 outline-none focus:ring-2 focus:ring-[#4945E7] dark:focus:ring-[#6A67F0] focus:border-transparent transition-all duration-200 group-hover:border-[#4945E7]/50 dark:group-hover:border-[#6A67F0]/50 text-right"
          />
      ...
      <div className="bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-700 p-3 rounded-xl border border-gray-200 dark:border-gray-600 space-y-2 transition-colors duration-300">
        <p className="text-sm font-semibold text-[#4945E7] dark:text-[#6A67F0] text-right">
          متطلبات كلمة المرور:
        </p>
