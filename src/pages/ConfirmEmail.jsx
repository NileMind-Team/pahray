        ...
        <div className="p-8">
          {loading ? (
            ...
            >
              ...
              <h2 className="text-2xl font-bold bg-gradient-to-r from-[#4945E7] to-[#6A67F0] bg-clip-text text-transparent text-center">
              ...
              <div className="flex space-x-2 justify-center mt-4">
                <div className="w-3 h-3 bg-[#4945E7] rounded-full animate-bounce"></div>
                <div
            ...
            >
              ...
              {/* Animated Dots */}
              <div className="flex space-x-2 justify-center mt-4">
                <div className="w-2 h-2 bg-[#4945E7] rounded-full animate-bounce"></div>
                <div
                  className="w-2 h-2 bg-[#6A67F0] rounded-full animate-bounce"
                  style={{ animationDelay: "0.2s" }}
                ></div>
                <div
                  className="w-2 h-2 bg-[#4945E7] rounded-full animate-bounce"
                  style={{ animationDelay: "0.4s" }}
                ></div>
              </div>
            </motion.div>
