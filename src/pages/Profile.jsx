...
export default function Profile() {
  ...
  if (!user) {
    return (
      <div
        className={`min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-[#f0f2ff] to-[#e0e5ff] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700`}
      >
  ...
  const fieldClass = `w-full border border-gray-200 bg-white/80 backdrop-blur-sm text-black rounded-xl px-4 py-3.5 outline-none focus:ring-2 focus:ring-[#4945E7] focus:border-transparent transition-all duration-200 hover:border-[#4945E7]/50 dark:bg-gray-600/80 dark:border-gray-500 dark:text-white text-right`;
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-br from-white via-[#f0f2ff] to-[#e0e5ff] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-4 py-4 sm:py-8 relative font-sans overflow-hidden transition-colors duration-300`}
      dir="rtl"
    >
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -left-20 -top-20 w-60 h-60 sm:w-80 sm:h-80 bg-gradient-to-r from-[#4945E7]/10 to-[#6A67F0]/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -right-20 -bottom-20 w-60 h-60 sm:w-80 sm:h-80 bg-gradient-to-r from-[#6A67F0]/10 to-[#4945E7]/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 sm:w-96 sm:h-96 bg-gradient-to-r from-[#4945E7]/5 to-[#6A67F0]/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <motion.button
        ...
        onClick={() => navigate(-1)}
        className="fixed top-4 left-4 z-50 bg-white/80 backdrop-blur-md hover:bg-[#4945E7] hover:text-white rounded-full p-2 sm:p-3 text-[#4945E7] border border-[#4945E7]/30 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl group dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#4945E7]"
      >
        <FaArrowLeft
          size={16}
      ...
      >
        {/* Header Background */}
        <div className="relative h-24 sm:h-32 bg-gradient-to-r from-[#4945E7] to-[#6A67F0] overflow-hidden">
          ...
          <div className="flex flex-col items-center text-center lg:flex-row lg:items-end lg:text-right gap-4 sm:gap-6 mb-6 sm:mb-8">
            ...
            >
              {user.avatar ? (
                ...
                <div
                  className={`w-20 h-20 sm:w-28 sm:h-28 lg:w-32 lg:h-32 rounded-full bg-gradient-to-r from-[#4945E7] to-[#6A67F0] text-white flex items-center justify-center text-2xl sm:text-3xl lg:text-4xl font-bold border-4 border-white shadow-2xl dark:border-gray-800`}
                >
              ...
              {isEditingProfile && activeTab === "profile" && (
                <label className="absolute bottom-1 left-1 sm:bottom-2 sm:left-2 bg-[#4945E7] hover:bg-[#6A67F0] text-white p-2 sm:p-3 rounded-full shadow-2xl cursor-pointer transition-all duration-300 hover:scale-110 group-hover:scale-110">
                  <input
                    type="file"
                    className="hidden"
            ...
            >
              {activeTab === "profile" && !isEditingProfile ? (
                <motion.button
                  ...
                  className={`flex items-center gap-2 bg-gradient-to-r from-[#4945E7] to-[#6A67F0] text-white px-4 py-2 sm:px-6 sm:py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl hover:shadow-[#4945E7]/25 transition-all duration-300 text-sm sm:text-base`}
                >
                  ...
                  {tabs.map((tab) => (
                    <motion.button
                      ...
                      className={`w-full flex items-center gap-3 p-4 text-right transition-all duration-200 ${
                        activeTab === tab.id
                          ? "bg-gradient-to-r from-gray-50 to-gray-100 text-[#4945E7] dark:from-gray-600 dark:to-gray-500"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        ...
                        <div
                          ...
                          className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-[#4945E7] cursor-pointer transition-all duration-200 hover:scale-110 dark:text-gray-400"
                        >
