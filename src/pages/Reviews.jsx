  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        onClick={() => navigate(-1)}
        className="fixed top-3 sm:top-4 left-3 sm:left-4 z-50 bg-white/80 backdrop-blur-md hover:bg-[#4945E7] hover:text-white rounded-full p-2 sm:p-3 text-[#4945E7] border border-[#4945E7]/30 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl group dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#4945E7]"
      >
        <FaArrowLeft
          size={14}
                ...
                >
                  <div className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 lg:p-6 border border-gray-200/50 shadow-lg sticky top-4 sm:top-6 dark:bg-gray-700/80 dark:border-gray-600/50">
                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                      ...
                      <button
                        onClick={resetForm}
                        className="text-gray-500 hover:text-[#4945E7] transition-colors duration-200 flex-shrink-0 ml-2 dark:text-gray-400"
                      >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <button
                            ...
                            className="w-full flex items-center justify-between border border-gray-200 bg-white rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 text-gray-600 hover:border-[#4945E7] transition-all group text-sm sm:text-base dark:bg-gray-600 dark:border-gray-500 dark:text-gray-300"
                          >
                              ...
                              >
                                {branches.map((branch) => (
                                  <li
                                    ...
                                    className="px-4 py-2.5 sm:py-3 hover:bg-gradient-to-r hover:from-[#f0f2ff] hover:to-[#e0e5ff] cursor-pointer text-gray-700 transition-all text-sm sm:text-base border-b border-gray-100 last:border-b-0 dark:hover:from-gray-600 dark:hover:to-gray-500 dark:text-gray-300 dark:border-gray-600"
                                  >
                                    {branch.name}
                                  </li>
                                ))}
                      ...
                      <div>
                        ...
                        <div className="flex items-center justify-between gap-2 bg-gradient-to-r from-[#f0f2ff] to-[#e0e5ff] p-2 sm:p-3 rounded-lg sm:rounded-xl border border-[#4945E7]/30 dark:from-gray-600 dark:to-gray-500 dark:border-gray-500">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs sm:text-sm font-semibold text-[#4945E7] whitespace-nowrap">
                              ({formData.rating}/5)
                            </span>
                          </div>
                        </div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          required
                          rows="4"
                          className="w-full border border-gray-200 bg-white text-black rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#4945E7] focus:border-transparent transition-all duration-200 text-sm sm:text-base resize-none dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                      ...
                      <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2">
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          onClick={resetForm}
                          className="flex-1 py-2.5 sm:py-3 border-2 border-[#4945E7] text-[#4945E7] rounded-lg sm:rounded-xl font-semibold hover:bg-[#4945E7] hover:text-white transition-all duration-300 text-sm sm:text-base dark:border-[#4945E7] dark:text-[#4945E7] dark:hover:bg-[#4945E7] dark:hover:text-white"
                        >
                          إلغاء
                        </motion.button>
                        <motion.button
