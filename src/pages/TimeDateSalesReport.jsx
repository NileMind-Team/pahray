                            ...
                            <div className="text-center">
                              ...
                              <p className="font-bold text-lg text-green-600 dark:text-green-400">
                                {isPriceBasedOnRequest ? (
                                  <span className="text-[#4945E7] dark:text-[#6A67F0]">
                                    السعر حسب الطلب
                                  </span>
                                ) : (
                          ...
                          <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                              ...
                              <div className="text-center col-span-2">
                                ...
                                <p className="text-lg font-bold text-[#4945E7] dark:text-[#6A67F0]">
          ...
          <div className="bg-gradient-to-r from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-xl font-bold text-[#4945E7] dark:text-[#6A67F0]">
...
<title>تقرير المبيعات بالوقت والتاريخ - أسماك بحري</title>
<style>
  @media print {
...
<div class="print-header">
  <h1>تقرير المبيعات بالوقت والتاريخ - أسماك بحري</h1>
...
<div class="print-footer">
  ...
  return (
    <div
      dir="rtl"
      className={`min-h-screen bg-gradient-to-br ${lightBackground} dark:${darkBackground} px-3 sm:px-4 md:px-6 py-6 relative font-sans overflow-hidden transition-colors duration-300`}
    >
      {/* Background decorations */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -left-10 -top-10 w-40 h-40 sm:w-60 sm:h-60 bg-gradient-to-r from-[#4945E7]/10 to-[#6A67F0]/10 rounded-full blur-2xl animate-pulse"></div>
        <div className="absolute -right-10 -bottom-10 w-40 h-40 sm:w-60 sm:h-60 bg-gradient-to-r from-[#6A67F0]/10 to-[#4945E7]/10 rounded-full blur-2xl animate-pulse"></div>
      </div>
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
              <div className="flex items-center gap-2">
                <FaCalendar className="text-[#4945E7] text-xl" />
            ...
            >
              <div>
                ...
                <div className="relative">
                  <FaCalendarAlt className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#4945E7]" />
                  <DatePicker
                    selected={startDate}
                    ...
                    className="w-full pl-10 pr-3 py-2.5 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-[#4945E7] focus:border-transparent outline-none text-right"
                    locale="ar"
              ...
              <div>
                ...
                <div className="relative">
                  <FaClock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#4945E7]" />
                  <input
                    type="time"
                    value={startTime}
              ...
              <div>
                ...
                <div className="relative">
                  <button
                    ...
                    className="w-full flex items-center justify-between border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-lg px-3 py-2.5 text-right focus:ring-2 focus:ring-[#4945E7] focus:border-transparent outline-none hover:border-[#4945E7] transition-all group"
                  >
                    <div className="flex items-center gap-3">
                      <FaBuilding className="text-[#4945E7] text-sm" />
                        ...
                        <div
                          ...
                          className={`px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-all text-sm border-b dark:border-gray-600 last:border-b-0 ${
                            selectedBranch?.id === branch.id
                              ? "bg-gradient-to-r from-[#f0f2ff] to-[#e0e5ff] dark:from-gray-700 dark:to-gray-600"
                              : ""
                          }`}
                        >
                          <span className="text-gray-700 dark:text-gray-300">
                  ...
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                      {reportData.map((order) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-center font-bold text-[#4945E7] dark:text-[#6A67F0]">
                    ...
                    <tfoot className="bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700">
                      <tr>
                        ...
                        <td className="px-4 py-3 text-center">
                          <span className="text-xl font-bold text-[#4945E7] dark:text-[#6A67F0]">
